...
const RIBBON_H = 96;
const PIN_SIZE = 108; // outerR × 2 ≈ 96px = llena RIBBON_H
const PIN_OVERHANG_TOP = 6;
...
export default function ReconocimientoSection() {
  const track = [...SEGMENTS, ...SEGMENTS]; // duplicado para el loop infinito
    ...
    >
      <div
        ...
        style={{
          ...
          overflow:        "hidden",
          // Máscara 2D: intersección de fade horizontal y vertical, para que
          // la cinta emerja del fondo de la página en vez de cortar en seco.
          WebkitMaskImage: [
